    ...
    public class JDBCConnect {
        ...
        public JDBCConnect(Product product) {
            ...
            try{
                ...
                String placeId=product.getPlaceId().replace("-","");
                String sql = "INSERT INTO Product_"+placeId + " VALUES "+"('" +  product.getCategory()+"', '"+ product.getName()+"', '"+product.getDescription()+"', '"+product.getPrice()+"')";
...
//                System.out.println(rs.getInt(1)+"  "+rs.getString(2)+"  "+rs.getString(3) + " "+ rs.getString(4)+" "+ rs.getString(5) );
        ...
        public JDBCConnect(String placeId,String category) {
            this.product=product;
            Connection conn = null;
            Statement stmt = null;
            try{
                ...
                String sql = "INSERT INTO Category_"+idPlace + " VALUES "+"('"+category+ "')";
                System.out.println(sql);
                stmt.executeUpdate(sql);
//            ResultSet rs=stmt.executeQuery("select * from Persons");
//
